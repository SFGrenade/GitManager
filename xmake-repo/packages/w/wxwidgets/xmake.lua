package("wxwidgets")
    ...
    on_source(function (package)
        if (package:is_plat("windows") or package:is_targetos("windows")) then
            if is_arch("x64") then
                package:add("urls", "https://github.com/wxWidgets/wxWidgets/releases/download/v$(version)/wxMSW-$(version)_vc14x_x64_Dev.7z")
                package:add("versions", "3.2.0", "02b7227916b98324f73ae9bed0f1cf27ae3157b4e3a3ded40ee8c0d570f0fd10")
                package:add("resources", "3.2.0", "releaseDLL",
                ...
                package:add("versions", "3.2.2", "b5d36e3ac9e01dc1a024344a0a28f9b99bdba75bafa119e1a626d8cc6fdef63d")
                package:add("resources", "3.2.2", "releaseDLL",
                ...
                package:add("versions", "3.2.3", "b8a6be72378d9947e303d7075a58c9bbc161d5debd25a187b654373b4d204873")
                package:add("resources", "3.2.3", "releaseDLL",
                ...
                package:add("versions", "3.2.4", "b8be152f08031aed2bfeffd17d8409209c38667859094b319818e08f7a4ad065")
                package:add("resources", "3.2.4", "releaseDLL",
                ...
                package:add("urls", "https://github.com/wxWidgets/wxWidgets/releases/download/v$(version)/wxMSW-$(version)_vc14x_Dev.7z")
                package:add("versions", "3.2.0", "0cd2387edcf1f26924d59efcc3ea4c8a00783ee01bf396756dabdd7967e4b37b")
                package:add("resources", "3.2.0", "releaseDLL",
                ...
                package:add("versions", "3.2.2", "7150112bece62f4eccd68d3b0eba11b5a1da0f773e864bdecb9840ce76160847")
                package:add("resources", "3.2.2", "releaseDLL",
                ...
                package:add("versions", "3.2.3", "8961f24abb16362a542140912f3c6cb75b8f95111816311ecf5b00ea1e0c55f3")
                package:add("resources", "3.2.3", "releaseDLL",
                ...
                package:add("versions", "3.2.4", "efa6bf76d42373e7930af18a176e5e52fbdd43f5da41b9bf6cd3b347d820f8b7")
                package:add("resources", "3.2.4", "releaseDLL",
            ...
            package:add("resources", "3.2.0", "headers",
            ...
            package:add("resources", "3.2.2", "headers",
            ...
            package:add("resources", "3.2.3", "headers",
            ...
            package:add("resources", "3.2.4", "headers",
            ...
            package:add("configs", "shared",     {description = "Build shared library.", default = true, type = "boolean", readonly = true})
            package:add("configs", "vs_runtime", {description = "Set vs compiler runtime.", default = "MD", readonly = true})
            package:add("configs", "debug",      {description = "Enable debug symbols.", default = false, type = "boolean", readonly = true})
        else
            package:add("urls", "https://github.com/wxWidgets/wxWidgets/releases/download/v$(version)/wxWidgets-$(version).tar.bz2",
                    "https://github.com/wxWidgets/wxWidgets.git")
            package:add("versions", "3.2.0", "356e9b55f1ae3d58ae1fed61478e9b754d46b820913e3bfbc971c50377c1903a")
            package:add("versions", "3.2.2", "8edf18672b7bc0996ee6b7caa2bee017a9be604aad1ee471e243df7471f5db5d")
            package:add("versions", "3.2.3", "c170ab67c7e167387162276aea84e055ee58424486404bba692c401730d1a67a")
            package:add("versions", "3.2.4", "0640e1ab716db5af2ecb7389dbef6138d7679261fbff730d23845ba838ca133e")
            package:add("versions", "3.2.5", "0ad86a3ad3e2e519b6a705248fc9226e3a09bbf069c6c692a02acf7c2d1c6b51")

            package:add("deps", "cmake")
            package:add("deps", "libjpeg", "libpng", "nanosvg", "expat", "zlib", "pango", "glib")
            if (package:is_plat("linux") or package:is_targetos("linux")) then
                package:add("deps", "opengl", "at-spi2-core")
                package:add("patches", "<=3.2.5", "patches/3.2.5/add_libdir.patch", "9a9fe4d745b4b6b09998ec7a93642d69761a8779d203fbb42a3df8c3d62adeb0")
            end
        end
    end)

    on_load(function (package)
        if (package:is_plat("macosx") or package:is_targetos("macosx")) then
            package:add("defines", "__WXOSX_COCOA__", "__WXMAC__", "__WXOSX__", "__WXMAC_XCODE__")
            package:add("frameworks", "AudioToolbox", "WebKit", "CoreFoundation", "Security", "Carbon", "Cocoa", "IOKit", "QuartzCore")
            package:add("syslinks", "iconv")
        elseif (package:is_plat("linux") or package:is_targetos("linux")) then
            package:add("defines", "__WXGTK3__", "__WXGTK__")
            package:add("syslinks", "pthread", "m", "dl")
            package:add("syslinks", "X11", "Xext", "Xtst", "xkbcommon")
            package:add("links", 
                "pango-1.0", "pangoxft-1.0", "pangocairo-1.0", "pangoft2-1.0"
            )
        elseif (package:is_plat("windows") or package:is_targetos("windows")) then
            package:add("defines", "WXUSINGDLL", "__WXMSW__", "wxSUFFIX=u", "wxMSVC_VERSION=14x")
            package:add("links", 
        ...
        if (package:is_plat("macosx", "linux") or package:is_targetos("macosx", "linux")) then
            ...
            if (is_plat("linux") or is_targetos("linux")) then
                 if package:config("shared") then
    ...
    on_install(function (package)
        ...
        elseif (package:is_plat("macosx", "linux") or package:is_targetos("macosx", "linux")) then
            ...
            local setupdir = (package:is_plat("macosx") or package:is_targetos("macosx")) and "osx" or "gtk"
